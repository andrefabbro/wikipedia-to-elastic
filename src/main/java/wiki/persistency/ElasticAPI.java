    ...
    private Map<String, WikipediaParsedPage> getNextScrollResults(SearchHit[] searchHits) {
        ...
        for (SearchHit hit : searchHits) {
            ...
            if (redirect != null && !redirect.isEmpty()) {
                wikiPairs.put(title, new WikipediaParsedPage(title, id, null, null, redirect, null, String.valueOf(id)));
            } else {
                wikiPairs.put(title, new WikipediaParsedPage(title, id, null, null, null, null, String.valueOf(id)));
            }
